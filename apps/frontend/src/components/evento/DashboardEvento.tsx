...
import Estatistica from "../shared/Estatisca";
...
export default function DashboardEvento(props: DashboardEventoProps) {
    return (
        <div className="flex flex-col gap-2">
            ...
            <span className="flex py-2 text-xl font-bold text-white/80">Convidado que confirmaram PRESENÇA:</span>
            <ListaConvidados convidados={props.presentes} />
            <span className="flex py-2 text-xl font-bold text-white/80">Convidado que confirmaram AUSÊNCIA:</span>
